...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'centrifuge'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from centrifuge.centrifugeImpl import centrifuge  # noqa @IgnorePep8
impl_centrifuge = centrifuge(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'centrifuge'
        ...
        self.rpc_service.add(impl_centrifuge.run_centrifuge,
